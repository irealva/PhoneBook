...
sub mainMenu {
  ...
  #my $wav_file = "inputs/confirmation1_16000.wav" ; # absolute path and name of the output wav file
...
sub finalMenu()
{
  ...
  #my $wav_file = "inputs/exit_16000.wav" ; # absolute path and name of the output wav file
  #system "./recognizePath.sh $wav_file /proj/speech/users/cs4706/pasr/HMM_G12 gramMain  >> output.txt" ;
...
sub personMenu {
  ...
  #system "./recognizePath.sh inputs/person/person1_16000.wav /proj/speech/users/cs4706/pasr/HMM_G12 gramPerson  >> output.txt" ;
...
sub telephoneMenu {
  ...
  #system "./recognizePath.sh inputs/telephone/telephone1_16000.wav /proj/speech/users/cs4706/pasr/HMM_G12 gramTelephone  >> output.txt" ;
...
sub stateMenu {
  ...
  #system "./recognizePath.sh inputs/state/state1_16000.wav /proj/speech/users/cs4706/pasr/HMM_G12 gramState  >> output.txt" ;
...
sub areaMenu {
  ...
  #system "./recognizePath.sh inputs/area/area1_16000.wav /proj/speech/users/cs4706/pasr/HMM_G12 gramArea  >> output.txt" ;
...
sub confirmationMenu {
  ...
  #system "./recognizePath.sh inputs/confirmation/con2_16000.wav /proj/speech/users/cs4706/pasr/HMM_G12 gramConfirmation  >> output.txt" ;
